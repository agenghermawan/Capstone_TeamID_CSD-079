...
<div style="margin: auto;width: 80%;text-align: center">
    ...
    <table style="font-family: 'Poppins', sans-serif;">
        <tr>
            ...
            <td width="300px" style="font-family: 'Poppins',sans-serif"> <STRONG> Indra Dr Spk </STRONG></td>
        </tr>
        <tr>
            <td style="font-family: 'Poppins',sans-serif"> Spesialisai </td>
            <td style="font-family: 'Poppins',sans-serif"> <strong>  {{$dataDokter->fullname}}</td>
        </tr>
        <tr>
