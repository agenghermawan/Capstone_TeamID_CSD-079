...
<div class="container" style="border-top: 2px solid blue">
    <div style="text-align: center;margin: auto;width: 80%;margin-top: 25px;margin-bottom: 10px;">
        <a style="background-color: red; padding: 10px; font-family: 'Poppins',sans-serif;border-radius: 8px;color: white;text-decoration: none" href="{{route('user.index')}}"> Permintaan Janji dengan Dokter telah <strong> Ditolak  </strong> </a>
    </div>
    ...
    <h4 style="font-family: 'Poppins', sans-serif;"> * Mohon maaf jadwal yang anda pilih tidak disetujui oleh Dokter yang anda ajukan </h4>
    <h4 style="font-family: 'Poppins', sans-serif;"> * Silahkan Ajukan pada lain waktu , Terima kasih telah menggunakan aplikasi SEHATKUAPP</h4>
