...
@section('contentFrontEnd')
    ...
    <main class="container-fluid">
        <img src="{{ asset('image/4968851.jpg') }}" class="shadow border" width="100%" height="400px"
            style="object-fit: cover" alt="">
        <div class="searchbar mb-5">
            <form action="{{ route('artikel_frontend') }}" style="width: 100%" class="d-flex">
                <input type="text" class="form-control shadow fs-3" name="searchArtikel"
                    placeholder="Silahkan cari Artikel yang anda sukai ....">
            ...
            @foreach ($data as $item)
                <div class="col-md-6 col-sm-12 my-5">
                    <div class="row">
                        <div class="col-md-6">
                            @if ($item->photo != null)
                                <img src="{{ Storage::url($item->photo) }}" alt="" class="rounded-lg shadow-lg"
                                    width="100%" style="object-fit: cover" height="200px">
                            @else
                                <img src="{{ asset('image/application.png') }}" alt="" class="rounded-lg shadow-lg"
                        ...
                        <div class="col-md-6  fs-3">
                            ...
                            <div class="readmore">
                                <a href="{{ route('artikelShow_frontend', $item->id) }}"
                                    class="btn btn-info text-light rounded mt-3"> Read More</a>
                            </div>
                        </div>
                    </div>
