...
@section('content')
    ...
    <div class="grid-cols-1 grid md:grid-cols-2 xl:grid-cols-3 mt-10">
        <div class="col-span-1 xl:col-span-2 p-5">
            <form action="">
                <input type="text" class="bg-white p-3 w-full rounded shadow-2xl border-none focus:border-blue-400"
                    placeholder="title">
        ...
        <div class="col-span-1 bg-white p-5 mt-5 shadow-2xl" style="height: 425px">
            ...
            <button type="submit" class="rounded from-bue-300 to-blue-200 bg-gradient-to-r my-2 p-3 shadow-2xl"> Submit
            </button>
        </div>
    </div>
