                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-3 sm:col-span-3">
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="sebagianDokter" id="sebagianDokter"
                                            class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                                            placeholder="Bagian Dokter">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="fullname" id="nama" autocomplete="given-name"
                                ...
                                <div class="col-span-6 sm:col-span-6">
                                    ...
                                    <select id="rumahSakit" name="rumahSakit" autocomplete="rumahSakit"
                                ...
                                <div class="col-span-6">
                                    <label for="noStr" class="block text-sm font-medium text-gray-700">
                                        NO STR</label>
                                    <input type="text" name="noStr" id="noStr" autocomplete="noStr"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                    <label for="status" class="block text-sm font-medium text-gray-700">Kode
                                        Status</label>
                                    <input type="text" name="status" id="status" autocomplete="status"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                <div class="col-span-6">
